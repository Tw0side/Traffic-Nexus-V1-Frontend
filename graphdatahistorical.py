...
def get_prevgraph_data(selected_datetime_start , selected_datetime_stop,datatime):
...
def prev_graphfilters(selected_datetime_start,selected_datetime_stop,protocol,traffic,datatime):    
    protocols = protocol  # List of protocols to filter
    traffic_types = traffic
    group=get_prevgraph_data(selected_datetime_start,selected_datetime_stop,datatime)
    filtered_df = group[
